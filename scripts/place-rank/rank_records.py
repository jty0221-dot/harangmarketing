...
# 판정 정본 : E:\하랑\본부장\병의원\인계_홈페이지_병의원_2026-09-05.md (치과 두 짝)
#             E:\하랑\본부장\병의원\인계_SEO_GEO_AEO_병의원_2026-09-06.md 제3절 (피부과 · D-0290)
# 여기에 줄을 추가하려면 진우 판정이 먼저다. 생각만으로 푸지 않는다.
#
# 피부과를 통과시켜도 게시하면 안 되는 줄은 안 실린다 — 진우 제3-B절이 그렇게 설계했다.
# 두 피부과 줄이 같은 짝(피부과 · 피부과)이라 게이트는 둘 다 지나지만 아래 규칙이 갈라 놓는다.
