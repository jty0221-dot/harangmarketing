...
const SECTIONS = [
  ...
  {
    title: "2. 청약철회 기간",
    content: `이용자는 계약 내용을 확인할 수 있는 날부터 7일 이내에 청약을 철회할 수 있습니다.\n다만 서비스 제공이 이미 시작된 부분과 아래 9번의 환불 제한 항목은 청약철회 대상에서 제외됩니다.`,
  },
  {
    title: "3. 계약 전 취소",
  ...
  },
  {
    ...
    content: `월 단위로 결제하신 경우 다음 달부터 멈추실 수 있고 위약금은 없습니다.\n여러 달을 한 번에 결제하신 경우에 한해, 서비스 착수(콘텐츠 발행, 계정 세팅 등 포함) 이후 중도 해지 시 아래 기준을 따릅니다.\n\n· 잔여 계약 기간 서비스료의 80% 환불 (이미 진행된 작업분 제외)\n· 단, 이용자 귀책 사유(허위 정보 제공, 계약 위반 등)로 인한 해지의 경우 환불 대상에서 제외될 수 있습니다.\n\n예시) 3개월 선결제, 1개월 진행 후 해지 시 → 나머지 2개월분의 80% 환불`,
  },
  {
    title: "6. 성과와 해지",
    content: `목표에 못 미치면 원인을 함께 보고 다음 달 작업 계획을 고칩니다. 성과 불만족으로 해지하시는 경우에도 환불은 위 기준을 따릅니다.\n단순 변심에 의한 환불도 위 기준을 따릅니다.`,
  },
  {
