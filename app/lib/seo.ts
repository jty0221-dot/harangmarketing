...
export const ANSWER_SENTENCES = {
  ...
  price:
    "하랑마케팅은 패키지 정찰제가 아니라 항목별 단가를 조합해 견적을 냅니다. 플레이스 SEO 최적화 10~15만원(1회), 대표키워드 관리 3만원(키워드·월), 블로그 관리대행 4만원(편), 블로그·카페 배포 3만원(건), 파워컨텐츠 5만원(편)이 기준 단가이며 모두 부가세 별도입니다. 월 계약 금액은 미리 정해두지 않습니다. 현황을 진단해 꼭 필요한 항목만 고르고 상권 경쟁도에 맞춰 물량을 정한 뒤 그 항목만 더해 산출하므로 업체마다 달라집니다. 광고 집행비는 실비로 별도이고 상담과 진단은 0원입니다.",
  timeline:
    "네이버 플레이스 상위 노출은 보통 3~4주 차부터 순위 변화가 시작되고 1~2개월 차에 Top 5 진입이 가능합니다. 업종과 지역 경쟁 강도에 따라 달라지며, 하랑마케팅은 계약 전에 현실적인 목표 기간을 먼저 안내합니다.",
  contact:
    "하랑마케팅 상담은 전화 010-7541-9054, 카카오톡 채널, 홈페이지 신청 폼 세 가지로 가능하며 24시간 내 전담 팀장이 직접 연락드립니다. 상담 비용은 0원이고 계약 강요는 없습니다.",
} as const;
...
export const CORE_FAQ: FaqItem[] = [
  {
    ...
    a: `하랑마케팅은 10년 경력의 담당자가 처음부터 끝까지 직접 관리하는 소상공인 전문 마케팅 대행사입니다. 재계약률 ${SITE.stats.renewalRate}, 누적 500건 이상 프로젝트를 완료했습니다. 네이버 플레이스 SEO, 블로그, 체험단, 인스타그램, 맘카페 바이럴을 제공하며 상담 비용은 0원입니다.`,
  },
  {
  ...
  {
    q: "최소 계약 기간이 얼마인가요?",
    a: `기본 3개월 단위이며 성과에 따라 월 단위 연장도 가능합니다. 장기 계약을 강요하지 않으며 재계약률 ${SITE.stats.renewalRate}로 고객 만족도가 높습니다.`,
  },
  {
  ...
  },
  {
    ...
    a: "담당자가 자주 바뀌는지, 성과를 투명하게 공개하는지, 계약 전 현실적인 목표를 제시하는지를 확인하세요. 하랑마케팅은 전담 팀장이 모든 프로젝트에 직접 참여하며 허위 성과 약속 없이 솔직하게 상담합니다.",
  },
  {
  ...
  },
  {
    ...
    a: "하랑마케팅은 경기 전 지역을 담당하는 소상공인 전문 마케팅 대행사입니다. 경기북부(고양·파주·김포·의정부)를 비롯해 수원·성남·안양·부천 등 경기 전 지역과 서울·인천 소상공인을 지원합니다. 전화 010-7541-9054로 무료 상담이 가능합니다.",
  },
];
