...
export const DEFINITIONS: { term: string; definition: string }[] = [
  ...
  },
  {
    term: "맘카페 바이럴",
    definition:
      "맘카페 바이럴은 지역 기반 주부 커뮤니티인 네이버 맘카페에서 실사용자 후기 형태로 매장을 알리는 마케팅입니다. 광고 티가 나지 않아 방문으로 이어지기 쉽고, 학원·카페·음식점·네일 업종에 특히 효과적입니다.",
  },
  {
    term: "카카오맵 마케팅",
    definition:
...
export const CORE_FAQ: FaqItem[] = [
  ...
  {
    q: "성과가 없으면 어떻게 되나요?",
    a: `매월 성과 리포트를 함께 검토하며 목표 미달 시 전략을 즉시 조정합니다. 작업한 글은 게시 URL 을 전부 드리고 매체사 전달 내역도 그대로 공개해 무엇이 나갔는지 직접 확인하실 수 있습니다. 계약 전에 성과 가능 여부를 솔직하게 먼저 안내드리며 ${SITE.stats.renewalRate} 재계약률이 그 신뢰를 증명합니다.`,
  },
  {
    q: "최소 계약 기간이 얼마인가요?",
  ...
  },
  {
    ...
    a: "맘카페 바이럴 마케팅은 지역 기반 주부 커뮤니티인 네이버 맘카페를 통해 매장을 홍보하는 방법입니다. 광고가 아닌 실사용자 후기처럼 자연스럽게 노출해 광고 글보다 거부감이 적습니다. 카페·학원·음식점·네일 업종에 특히 효과적입니다.",
  },
  {
   ...
   */
  {
    ...
    a: "AI 답변에는 순위표가 없어서 몇 위인지 잴 수가 없습니다. 그래서 노출을 보장한다는 말씀은 드리지 않습니다. 대신 읽힐 수 있게 만들어 둡니다. 하랑마케팅 홈페이지는 AI 크롤러 접근을 막지 않고, 자주 묻는 질문을 질문과 답 형태로 정리하고, 회사 · 서비스 · 지역 정보를 구조화 데이터로 붙여 두었습니다. 숫자로 약속드리는 것은 지금도 매일 재고 있는 네이버 플레이스 순위뿐입니다.",
  },
  /*
  ...
  },
  {
    ...
    a: "미리 약속하지 않습니다. 의료법 제56조 제2항은 근거 없는 비교와 과장을 금지하고 있어 앞으로 몇 위가 된다는 말은 병원 광고에 쓸 수 없습니다. 대신 매일 저장한 스냅샷으로 지금 몇 위인지와 며칠째 그 자리인지를 숫자로 보여 드립니다.",
  },
  {
    q: "병원에 체험단을 쓸 수 있나요?",
