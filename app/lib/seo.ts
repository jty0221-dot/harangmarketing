...
export const ANSWER_SENTENCES = {
  ...
  price:
    "하랑마케팅은 패키지 정찰제가 아니라 항목별 단가로 견적을 냅니다. 플레이스 SEO 최적화 10~15만원(1회), 대표키워드 관리 3만원(키워드·월), 블로그 관리대행 4만원(편), 블로그·카페 배포 3만원(건), 파워컨텐츠 5만원(편)이 기준 단가입니다. 실제 계약은 한 채널만 하면 월 30만원, 두세 채널을 묶으면 월 45~77만원(평균 61만원), 전 채널 통합은 월 120~220만원(평균 167만원)이며 모두 부가세 별도입니다. 광고 집행비는 실비로 별도이고 상담과 진단은 0원입니다.",
  timeline:
