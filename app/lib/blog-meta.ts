...
export const BLOG_META: BlogMeta[] = [
  ...
  },
  {
    ...
    excerpt: "체험단은 빠르고 리뷰는 신뢰도가 높습니다. 업종별로 어느 방식에 무게를 둘지 판단하는 기준을 정리했습니다.",
    tag: "체험단·리뷰",
    date: "2024-11-15",
  },
  {
    ...
    excerpt: "릴스 한 편이 어떤 구조로 만들어지는지 정리했습니다. 어떤 내용을, 어떻게 촬영하고, 무슨 해시태그를 달지 단계별로 공개합니다.",
    tag: "SNS 마케팅",
    date: "2024-11-22",
  },
  {
    ...
    excerpt: "배달앱에서 순위를 올리는 방법은 광고비가 아닙니다. 리뷰 수와 평점, 사장님 댓글이 핵심입니다. 4개월 동안 무엇을 순서대로 하는지 공개합니다.",
    tag: "업종별 전략",
    date: "2024-12-01",
  },
  {
    ...
    excerpt: "작은 예산으로 가장 효과적인 조합을 찾는 방법. 대표 10년 경력 누적 500건 프로젝트 데이터를 바탕으로 예산별 최적 전략을 제시합니다.",
    tag: "마케팅 비용",
    date: "2024-12-08",
  },
  {
  ...
  },
  {
    ...
    excerpt: "리뷰가 없으면 순위가 없고, 순위가 없으면 방문객이 없습니다. 리뷰를 안전하게 쌓는 3개월 로드맵을 공개합니다.",
    tag: "리뷰 마케팅",
    date: "2025-01-05",
  },
  {
    ...
    excerpt: "네이버만 신경 쓰다가 카카오맵을 놓치는 사장님이 많습니다. 카카오맵 트렌드 랭킹 상위 진입 전략을 공개합니다.",
    tag: "카카오맵",
    date: "2025-01-12",
  },
  {
  ...
  },
  {
    ...
    excerpt: "미용 업종은 비포애프터 한 장이 설명 열 줄보다 강합니다. 어떻게 찍고, 어떻게 올리고, 팔로워를 예약으로 전환하는지 실전 전략을 공개합니다.",
    tag: "SNS 마케팅",
    date: "2025-01-26",
  },
  {
  ...
  },
  {
    ...
    excerpt: "학원 마케팅은 학부모를 설득하는 일입니다. 학부모가 가는 채널에 집중해 상담 문의로 잇는 3개월 실전 과정을 공개합니다.",
    tag: "업종별 전략",
    date: "2025-02-23",
    unlisted: true,
  },
