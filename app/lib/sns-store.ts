...
export const SNS_FAQ: SnsFaqItem[] = [
  ...
  },
  {
    ...
    a: "플랫폼 정기 점검 때 일부가 줄어들 수 있습니다. 진행 후 30일 안에 주문하신 수치보다 줄어들면 카카오톡으로 알려주세요. 확인 후 줄어든 만큼 다시 채워 드립니다.",
  },
  {
    q: "검색 순위나 알고리즘 노출까지 올려 주나요?",
    a: "그 부분은 약속드리지 않습니다. 각 플랫폼의 알고리즘 기준은 공개되어 있지 않기 때문입니다. 이 스토어의 작업 범위는 주문하신 수치(팔로워·좋아요·조회수 등)가 채워지는 것까지입니다. 노출 전략이 필요하시면 대행 서비스 상담을 이용해 주세요.",
  },
  {
    q: "결제는 어떻게 하나요?",
  ...
  {
    q: "일반 업체와 뭐가 다른가요?",
    a: "하랑마케팅은 창업 전 경력까지 합쳐 10년 동안 소상공인 마케팅을 해 온 대표가 운영하는 대행사이고, 이 스토어의 프로그램은 저희가 실제 고객사 캠페인에 쓰는 것과 같습니다. 계정 상태에 맞지 않는 과주문은 접수 단계에서 저희가 먼저 말리고, 진행 상황은 주문 조회 페이지에서 실시간으로 확인됩니다.",
  },
];
