...
const FAQS = [
  ...
  { q: "월 얼마부터 시작할 수 있나요?", a: "월 금액은 매장마다 다릅니다. 항목별 단가를 정해두고 매장에 꼭 필요한 항목만 골라 더하기 때문입니다. 블로그 관리대행 편당 4만원처럼 기준 단가는 서비스 안내에 공개해 두었고, 카페 월 보장처럼 시작 금액을 공개한 상품은 그 금액부터입니다. 진단 후 항목과 물량이 그대로 보이는 견적서를 드리고, 안 쓰는 항목은 빼고 계산합니다." },
