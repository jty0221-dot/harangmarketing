 ...
 *   · 첫 연락 시점은 약속하지 않는다. 카카오톡 문의를 24시간 접수한다는 사실만 적는다 (2026-09-25 결재 · 상담은 평일)
...
const STEPS = [
  ...
  },
  {
    ...
    title: "맞춤 전략 제안",
    duration: "D+3",
    desc: "월 금액은 매장마다 다릅니다. 진단 결과에서 이 매장에 꼭 필요한 항목만 골라, 항목별 단가와 물량을 그대로 적은 견적서를 드립니다.",
    details: [
  ...
  },
  {
    ...
    title: "계약 및 킥오프",
    duration: "D+4~7",
    desc: "계약 후 즉시 킥오프 미팅에서 세부 실행 계획을 확정합니다. 대표가 직접 관리합니다.",
    details: [
      "표준 계약서 작성 (전자서명 가능)",
      "계정 권한·소재·자료 인수인계",
      "계약 당일 실행 착수",
...
const TRUST_POINTS = [
  { icon: ShieldCheck, label: "게시 URL 전체 전달 · 작업 내역 공개" },
  { icon: Star, label: "10년 경력 누적 500건 프로젝트" },
  { icon: Clock, label: "카카오톡 24시간 접수" },
];
...
const FAQS = [
  ...
  { q: "월 얼마부터 시작할 수 있나요?", a: "월 금액은 매장마다 다릅니다. 항목별 단가를 정해두고 매장에 꼭 필요한 항목만 골라 더하기 때문입니다. 블로그 관리대행 편당 4만원처럼 기준 단가는 서비스 안내에 공개해 두었고, 카페 월 단위 관리처럼 시작 금액을 공개한 상품은 그 금액부터입니다. 진단 후 항목과 물량이 그대로 보이는 견적서를 드리고, 안 쓰는 항목은 빼고 계산합니다." },
  ...
  { q: "작업 내용을 어떻게 확인할 수 있나요?", a: "매월 말 플랫폼별 순위·리뷰 수 등 저희가 직접 계측한 수치로 상세 리포트를 제공합니다. 매출·방문객은 계측 대상이 아니라 리포트에 넣지 않습니다. 언제든지 카카오톡으로 진행 상황을 문의하실 수 있습니다." },
];
      ...
      <main className="pt-[104px] md:pt-[108px]">
        ...
        <section className="py-14 bg-blue-600">
          <div className="max-w-2xl mx-auto px-4 text-center">
            ...
            <p className="text-blue-50 text-sm mb-7">상담 비용 0원 · 계약 강요 없음 · 카카오톡 24시간 접수</p>
