...
const POSTS: Record<string, {
    ...
    sections: [
      {
        ...
        tips: [
          ...
          "방문자 리뷰(포토리뷰) 비중 · 사진이 붙은 리뷰를 우선해 요청한다",
        ],
      },
      {
  ...
  "cafe-blog-keywords": {
    ...
    sections: [
      ...
      },
      {
        ...
        tips: [
          "제목: [지역명+키워드] 형태로 제목에 키워드 포함 (예: '지역명 분위기좋은카페 추천 TOP5')",
  ...
  "review-vs-experience": {
    ...
    tagColor: "bg-blue-50 text-blue-600",
    readTime: "5분",
    result: "업종별 체험단·리뷰 비중 · 시작 전 점검표",
    summary: "체험단은 빠르고 리뷰는 신뢰도가 높습니다. 업종별로 어느 방식에 무게를 둘지 판단하는 기준을 정리했습니다.",
    sections: [
      {
      ...
      },
      {
        ...
        tips: [
          ...
          "병원·의원 · 체험단 없이 실제 방문 리뷰만 (의료법 제56조 제2항 주의)",
        ],
      },
      {
        ...
        tips: [
          ...
          "대가를 받고 쓴 글에는 그 사실을 표시해야 합니다 (표시광고법)",
        ],
      },
    ],
    cta: "체험단 모집 대행 문의하기",
  ...
  "instagram-reels-beauty": {
    title: "미용실·네일 인스타그램 릴스 실전 가이드",
    tag: "SNS 마케팅",
    tagColor: "bg-blue-50 text-blue-700",
    readTime: "7분",
    result: "릴스 기획 · 촬영 · 해시태그 · 업로드 시간대",
    summary: "릴스 한 편이 어떤 구조로 만들어지는지 정리했습니다. 어떤 내용을, 어떻게 촬영하고, 무슨 해시태그를 달지 단계별로 공개합니다.",
    sections: [
      {
        heading: "왜 릴스가 미용·네일 업종에 효과적인가요?",
        body: "미용과 네일은 시각적 변화가 극적입니다. 비포/애프터를 보여주는 짧은 영상 하나가 수천 명의 잠재 고객에게 도달합니다. 인스타그램 알고리즘은 팔로워 수와 관계없이 좋은 릴스를 추천 탭에 노출시킵니다.",
        tips: [
      ...
      {
        heading: "해시태그 전략",
        body: "무작정 많이 다는 것보다 '지역+업종' 조합이 핵심입니다. 지역명을 앞에 붙이는 해시태그 조합입니다.",
        tips: [
          "필수: #지역명네일 #지역명네일샵 #지역명네일아트 (지역 특화)",
  ...
  "delivery-review-formula": {
    title: "음식점 배달앱 리뷰 마케팅 공식",
    tag: "업종별 전략",
    tagColor: "bg-indigo-50 text-indigo-700",
    readTime: "9분",
    result: "배달앱 리뷰 요청 · 답글 운영 · 이벤트 기준",
    summary: "배달앱에서 순위를 올리는 방법은 광고비가 아닙니다. 리뷰 수와 평점, 사장님 댓글이 핵심입니다. 4개월 동안 무엇을 순서대로 하는지 공개합니다.",
    sections: [
      {
        ...
        tips: [
          ...
          "평점 4.5 이상 유지 · 한 번 내려가면 되돌리는 데 오래 걸린다",
    ...
    sections: [
      {
        ...
        body: "결론부터 말씀드리면 '가능합니다', 단 업종과 경쟁 강도에 따라 달라집니다. 핵심은 예산을 넓게 쓰지 않고 1~2개 채널에 집중하는 것입니다.",
        tips: [
  ...
  "momcafe-viral-guide": {
    ...
    tagColor: "bg-indigo-50 text-indigo-700",
    readTime: "7분",
    result: "맘카페 게시 원칙 · 업종별 콘텐츠 · 금지 행위",
    summary: "맘카페는 '구매 결정권을 가진 주부'가 모이는 최고의 로컬 마케팅 채널입니다. 자연스럽게 입소문을 내면서 효과를 내는 방법을 공개합니다.",
    sections: [
      {
        heading: "왜 맘카페인가요?",
        body: "맘카페는 네이버 카페 중에서도 지역 기반 주부 커뮤니티입니다. '동네 맛집 어디가 좋아요?', '어린이집 어디가 좋아요?'처럼 실생활 구매 결정을 하는 곳입니다. 이 채널의 가장 큰 장점은 신뢰도입니다. 광고가 아닌 '이웃의 추천'으로 받아들여지기 때문에 거부감이 적습니다.",
        tips: [
          "카페·음식점·학원·키즈 관련 업종에 특히 효과적",
          "주부 타겟 고객이 많은 뷰티·네일 업종에 맞는 채널",
          "게시글 하나가 같은 동네 회원에게 바로 닿는 고밀도 채널",
        ],
      },
      {
  ...
  "naver-place-review-100": {
    ...
    tagColor: "bg-blue-50 text-blue-700",
    readTime: "8분",
    result: "리뷰 100개까지 3개월 로드맵 · 요청 문구",
    summary: "리뷰가 없으면 순위가 없고, 순위가 없으면 방문객이 없습니다. 리뷰를 안전하게 쌓는 3개월 로드맵을 공개합니다.",
    sections: [
      {
        heading: "왜 리뷰 100개가 기준선인가요?",
        body: "네이버 플레이스 알고리즘에서 리뷰 수는 가장 직관적인 신뢰 지표입니다. 100개가 '마법의 숫자'는 아니지만, 대부분의 업종에서 심리적 신뢰 임계점이 되는 기준입니다.",
        tips: [
      ...
      },
      {
        ...
        tips: [
          ...
          "키워드 자연 삽입 · '지역명 카페' '주차 편한 카페' 등 SEO 키워드 1~2개",
  ...
  "kakaomap-marketing-guide": {
    title: "카카오맵 마케팅 완전 가이드",
    tag: "카카오맵",
    tagColor: "bg-yellow-50 text-yellow-700",
    readTime: "7분",
    result: "카카오맵 정보 등록 · 리뷰 · 트렌드 랭킹",
    summary: "네이버만 신경 쓰다가 카카오맵을 놓치는 사장님이 많습니다. 카카오맵 트렌드 랭킹 상위 진입 전략을 공개합니다.",
    sections: [
      {
        heading: "왜 카카오맵을 놓치면 안 되나요?",
        body: "네이버 지도만 쓰는 사람이 있고 카카오맵만 쓰는 사람이 있습니다. 네이버 플레이스에만 집중하면 카카오맵으로 검색하는 고객은 경쟁사에게 넘어갑니다. 두 곳은 정보도 리뷰도 따로 관리해야 합니다.",
        tips: [
      ...
      },
      {
        ...
        tips: [
          "트렌드 랭킹은 짧은 기간에 검색·저장·리뷰가 함께 늘어난 매장을 잡아 올린다",
      ...
      {
        heading: "트렌드 랭킹을 노리는 2개월 실행 순서",
        body: "카카오맵을 처음 세팅하는 매장이 두 달 동안 무엇을 순서대로 하는지 정리했습니다.",
        tips: [
          "1주차: 매장 관리 채널 개설 + 정보 100% 완성 (메뉴·영업시간·대표번호·사진 10장 이상)",
          "2주차: 기존 단골 고객에게 카카오맵 리뷰 요청 (문자 또는 구두) · 목표 20개",
          "3~4주차: 체험단 10명 모집 → 카카오맵 리뷰 작성 요청. 대가를 받고 쓴 글에는 그 사실을 표시해야 합니다",
      ...
      },
      {
        ...
        body: "네이버 플레이스와 카카오맵은 서로 다른 고객층을 커버합니다. 한쪽만 하면 다른 쪽으로 검색하는 고객이 통째로 빠집니다.",
        tips: [
          "네이버 플레이스 · 검색창에 바로 쳐서 찾는 고객이 많다",
          "카카오맵 · 지도를 열어 주변을 훑는 고객이 많다",
  ...
  "clinic-marketing-guide": {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "어디서부터 시작해야 할지 막막하다면 아래 순서대로 진행해보세요. 의원·한의원에서 순서대로 밟는 6개월 로드맵입니다.",
        tips: [
  ...
  "beauty-instagram-follower": {
    title: "미용실·네일 인스타그램 계정 키우는 법",
    tag: "SNS 마케팅",
    tagColor: "bg-pink-50 text-pink-600",
    readTime: "7분",
    result: "콘텐츠 설계 · 3개월 운영 · 예약 전환 동선",
    summary: "미용 업종은 비포애프터 한 장이 설명 열 줄보다 강합니다. 어떻게 찍고, 어떻게 올리고, 팔로워를 예약으로 전환하는지 실전 전략을 공개합니다.",
    sections: [
      {
        ...
        tips: [
          "비포애프터 사진 · 계정에서 가장 많이 저장되는 콘텐츠",
          "릴스 · 팔로워 밖으로 나가는 유일한 형식",
      ...
      },
      {
        ...
        tips: [
          "1개월: 체험단 5명 · 기본 피드 15개 확보. 대가를 받고 쓴 글에는 그 사실을 표시해야 합니다",
          "2개월: 릴스 주 2회 업로드 · 시술 과정 타임랩스·비포애프터·Q&A",
          "3개월: 예약 현황 스토리 공지 → 문의 동선 정리 → DM 예약 안내",
        ],
      },
      {
  ...
  "google-maps-seo": {
    ...
    tagColor: "bg-blue-50 text-blue-600",
    readTime: "6분",
    result: "구글 비즈니스 프로필 완성 · 리뷰 확보",
    summary: "네이버만 보다가 구글 지도를 놓치면 MZ세대와 외국인 방문객을 잃습니다. 구글 비즈니스 프로필 최적화, 리뷰 전략, 사진 관리법을 공개합니다.",
    sections: [
      {
        heading: "왜 구글 지도인가?",
        body: "젊은 층과 외국인 방문객은 구글 지도로 먼저 찾습니다. 관광지 인근이나 젊은 상권이라면 구글 최적화가 필수입니다.",
        tips: [
          "외국인 방문객 · 한국어 검색이 어려워 구글 지도로 찾는다",
  ...
  "keyword-research-local": {
    ...
    tagColor: "bg-blue-50 text-blue-700",
    readTime: "8분",
    result: "키워드 3단계 분류 · 무료 발굴법 · 업종별 예시",
    summary: "키워드를 잘못 고르면 글을 100개 써도 손님이 안 옵니다. 검색량은 많지만 경쟁이 낮은 '틈새 키워드'를 찾는 방법을 단계별로 공개합니다.",
    sections: [
      {
        heading: "왜 키워드가 전부인가?",
        body: "블로그 글을 열심히 써도 유입이 없다면 '아무도 검색하지 않는 키워드'나 '경쟁이 너무 높은 키워드'를 고른 것입니다. 키워드 선정에서 대부분이 갈립니다.",
        tips: [
          "대형 키워드 (예: '카페') · 검색량 많지만 경쟁이 극도로 높아 진입 불가",
          "중형 키워드 (예: '지역명 카페') · 현실적 목표, 3~6개월 소요",
          "롱테일 키워드 (예: '지역명 분위기 좋은 카페 데이트') · 경쟁 낮고 전환율 높음",
        ],
      },
      {
  ...
  "review-response-templates": {
    ...
    tagColor: "bg-blue-50 text-blue-700",
    readTime: "5분",
    result: "별점별 · 상황별 답글 템플릿 20선",
    summary: "리뷰에 답글 달기가 귀찮은 가장 큰 이유는 뭐라고 써야 할지 모르기 때문입니다. 별점별·상황별 답글 20가지 템플릿을 공개합니다.",
    sections: [
      {
        heading: "왜 답글이 순위에 영향을 주나요?",
        body: "답글이 달린 매장은 살아 있는 매장으로 읽힙니다. 손님이 다음에 올지 말지를 답글 하나로 정하기도 합니다. 5분이면 되는데 안 하는 매장이 많습니다.",
        tips: [
  ...
  "academy-marketing-guide": {
    title: "학원 마케팅 실전 가이드 · 맘카페부터 블로그까지",
    tag: "업종별 전략",
    tagColor: "bg-indigo-50 text-indigo-700",
    readTime: "8분",
