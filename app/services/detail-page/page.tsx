    ...
    <>
      ...
      <main className="pt-[104px] md:pt-[108px]">
        ...
        <AnswerBlock
          ...
          answer="하랑마케팅 상세페이지 제작은 세 등급입니다. 기획만 받는 기획형 150,000원, 기획과 이미지 제작을 함께 하는 제작형 350,000원, 첫 화면 훅 GIF 와 숏폼 1편까지 붙는 제작+영상형 550,000원입니다. 상품 3종에 스토어 스킨과 배포 원고까지 묶는 브랜드 패키지 1,500,000원도 있습니다. 제작은 이미지부터가 아니라 구성 기획부터 시작합니다. 어떤 불안을 몇 번째 화면에서 지울지 정한 다음 9단 구성표와 카피를 만들고 그 다음에 이미지를 만듭니다. 제품 사진이 아직 없어도 촬영 기획안부터 진행할 수 있습니다. 상담과 견적은 0원입니다."
          facts={[
