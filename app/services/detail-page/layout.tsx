...
export const metadata: Metadata = {
  ...
  description:
    "스마트스토어 상세페이지를 9단 구성으로 만듭니다. 기획형 150,000원 · 제작형 350,000원 · 제작+영상형 550,000원. 어떤 불안을 몇 번째 화면에서 지우는지부터 정하고 시작합니다. 공정 전체를 공개합니다.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "이미지를 파는 게 아니라 순서를 팝니다. 9단 구성 · 게이트 2개 · 공정 전체 공개. 150,000원부터.",
    url: URL,
