...
import { SITE, ORG_ID, breadcrumbLd, webPageLd, updatedAt, ogImage } from "../../../lib/seo";
import {
...
export const metadata: Metadata = {
  ...
  description: `스마트스토어 상세페이지 실물 ${REF_TOTAL}건을 공개합니다. 생활·리빙, 수납·가구, 차량, 뷰티·헬스, 반려동물, 유아, 패션, 식품 등 ${REF_CATEGORIES.length}종입니다.`,
  keywords: [
  ...
  openGraph: {
    ...
    url: URL,
    images: [ogImage("하랑마케팅 상세페이지 레퍼런스")],
  },
};
