...
export const metadata: Metadata = {
  title: "의원·한의원·피부과 마케팅 대행 — 하랑마케팅 | 의료법 준수 · 플레이스 SEO",
  description: "의원·한의원·피부과 전문 마케팅. 의료법 준수 블로그, 플레이스 상위노출, 리뷰 관리. 지역 치과 키워드 5위 → 1위, 32일 계측 기록. 무료 상담 0원.",
  ...
  openGraph: {
    ...
    description: "의료법 준수 블로그 · 플레이스 SEO · 리뷰 관리. 지역 치과 키워드 5위 → 1위, 32일 계측 기록.",
