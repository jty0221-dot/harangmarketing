...
import { PRICE_MIN, CAFE_TIER_MIN, REF_TOTAL, won } from "../../lib/cafe-distribution";
...
export const metadata: Metadata = {
  ...
  description:
    `네이버 최적화 블로그 배포와 카페 배포를 함께 진행합니다. 블로그 탭과 카페 탭 동시 노출로 검색 유입 경로를 넓히세요. 10건 · 30건 패키지 ${won(PRICE_MIN)}부터, 카페 단건 ${won(CAFE_TIER_MIN)}부터. 업종별 실사 레퍼런스 ${REF_TOTAL}건 공개.`,
  keywords: [
  ...
  openGraph: {
    ...
    description:
      `블로그 탭 + 카페 탭 동시 노출. 10건 · 30건 패키지 ${won(PRICE_MIN)}부터, 카페 단건 ${won(CAFE_TIER_MIN)}부터. 업종별 실사 레퍼런스 ${REF_TOTAL}건.`,
    url: URL,
