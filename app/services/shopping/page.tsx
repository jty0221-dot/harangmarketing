    ...
    <>
      ...
      <main className="pt-[104px] md:pt-[108px]">
        ...
        <AnswerBlock
          ...
          answer="온라인 쇼핑몰은 오프라인 매장과 달리 지역 키워드가 없으므로 상품 키워드 블로그 SEO와 체험단 후기 확보가 출발점입니다. 검색으로 유입된 고객이 후기를 보고 구매를 결정하기 때문입니다. 하랑마케팅이 진행한 온라인 쇼핑몰은 4개월 만에 월 매출이 230만원에서 377만원으로 64% 증가했습니다. 쇼핑몰 마케팅은 전국 어디서나 비대면으로 진행되며 비용은 월 30만원부터입니다."
          facts={[
