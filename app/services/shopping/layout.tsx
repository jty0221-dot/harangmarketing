...
export const metadata: Metadata = {
  title: "온라인 쇼핑몰 마케팅 대행 — 하랑마케팅 | 블로그 SEO · 체험단",
  description: "온라인 쇼핑몰 전문 마케팅. 블로그 SEO 최적화, 체험단 후기 확보, 콘텐츠 마케팅을 전담 팀장이 직접 진행합니다. 무료 상담 0원.",
  ...
  openGraph: {
    ...
    description: "블로그 SEO · 체험단 후기 · 콘텐츠 마케팅. 전담 팀장 직접 관리 · 상담 0원.",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "brand": { "@id": ORG_ID },
            "inLanguage": "ko-KR",
            "serviceOutput": { "@type": "Thing", "name": "플레이스 순위 계측 기록", "description": "온라인 쇼핑몰 전문 마케팅. 계측 기록: 네이버 플레이스 지역 카페 키워드 19위→1위(20일), 지역 맛집 키워드 13위→1위(32일), 지역 치과 키워드 5위→1위(32일). 순위는 매일 저장한 스냅샷 실측값이며 방문객·매출은 계측 대상이 아니다." },
