...
const WORKS = [
  {
    ...
    body:
      "프로필부터 계정 안전까지 30개 항목을 직접 잽니다. 문제 다섯 가지와 4주 실행표로 정리하고, 못 재는 값은 측정 불가로 남깁니다.",
  },
  {
    icon: Layers,
    name: "하이라이트 세팅",
    ...
    body:
      "여섯 칸을 방문자가 묻는 순서대로 세웁니다. 커버 시안 중 하나를 고르시면 그 계열로 맞추고, 칸마다 스토리를 서너 장씩 채웁니다.",
  },
  {
    icon: Camera,
    name: "콘텐츠 정기 발행",
    ...
    body:
      "무엇을 언제 올릴지 저희가 정하고 릴스는 영상팀이 만듭니다. 반응이 났던 글을 다시 쓰고, 몰아 올리고 비우지 않습니다.",
  },
  {
    icon: TrendingUp,
    name: "반응이 난 글의 확산",
    ...
    body:
      "반응이 나기 시작한 글에, 올린 직후 몇 시간 안에만 붙입니다. 반응 없는 글과 빈 계정에는 쓰지 않습니다.",
  },
];
...
const NOT_DOING = [
  {
    title: "몇 번째로 올려 드린다는 말을 하지 않습니다",
...
const STEPS = [
  {
    no: "01",
    name: "계정을 잽니다",
    text: "계정 아이디만 주시면 로그인 없이 먼저 재 봅니다. 여기까지 비용이 들지 않습니다.",
  },
  {
    no: "02",
    name: "진단서를 드립니다",
    text: "문제 다섯 가지와 4주 실행표를 드립니다. 보고 진행 여부를 정하시면 됩니다.",
  },
  {
    no: "03",
    name: "프로필과 하이라이트를 세팅합니다",
    text: "이름 칸, 소개글, 링크를 먼저 고치고 하이라이트 여섯 칸을 채웁니다.",
  },
  {
    no: "04",
    name: "정기 발행을 시작합니다",
    text: "피드, 스토리, 릴스를 정해진 간격으로 올립니다.",
  },
  {
    no: "05",
    name: "매달 무엇이 움직였는지 보고드립니다",
    text: "도달, 프로필 방문, 저장과 공유, 링크 클릭을 재서 드립니다.",
  },
];
...
const FAQS: FaqItem[] = [
  ...
  {
    q: "인기 게시물에 몇 번째로 올려 주시나요?",
    a: "인기 게시물에 몇 번째로 올려 드린다는 말을 하지 않습니다. 인스타가 기준을 언제 바꾸는지, 같은 해시태그를 쓰는 다른 계정이 무엇을 올리는지는 저희가 정하지 못하기 때문입니다. 대신 도달과 프로필 방문과 저장이 어떻게 움직였는지를 매달 재서 그대로 보여 드립니다.",
  },
  {
    q: "계정 비밀번호를 드려야 하나요?",
    ...
    <>
      ...
      <main className="pt-[104px] md:pt-[108px]">
        ...
        <section className="bg-gray-950 py-16 md:py-24">
          <div className="max-w-4xl mx-auto px-4 md:px-6">
            ...
            <p className="mt-5 text-sm md:text-base text-gray-300 leading-relaxed max-w-2xl">
              프로필에 들어온 사람이 나가는 이유는 대개 게시물이 아니라 세팅입니다. 뭐 하는 곳인지 바로 안 보이고, 하이라이트가 비었고, 링크가 상담으로 안 이어집니다. 30개 항목을 재서 막힌 곳부터 찾습니다.
            </p>
        ...
        <AnswerBlock
          ...
          answer="인스타그램 계정 최적화는 프로필과 콘텐츠와 하이라이트와 지표와 계정 안전 다섯 갈래를 30개 항목으로 실측해서 방문자가 프로필에서 나가는 지점을 찾아 고치는 작업입니다. 하랑마케팅은 계정을 진단해 문제 다섯 가지와 4주 실행표를 드리고, 하이라이트 여섯 칸을 세팅한 다음 피드와 스토리와 릴스를 정기 발행합니다. 팔로워와 좋아요를 사서 늘리는 방식은 쓰지 않고 몇 번째로 올려 드린다는 말을 하지 않습니다. 상담과 진단 비용은 0원입니다."
          facts={[
        ...
        <section className="py-14 md:py-20 bg-white">
          <div className="max-w-4xl mx-auto px-4 md:px-6">
            ...
            <p className="mt-4 text-sm md:text-base text-gray-600 leading-relaxed">
              광고로 데려오는 것과 데려온 사람이 남는 것은 다른 일입니다. 계정이 준비되지 않으면 들어온 사람이 그대로 나가서 진단부터 합니다.
            </p>
        ...
        <section className="py-14 md:py-20" style={{ background: "var(--h-surface)" }}>
          <div className="max-w-4xl mx-auto px-4 md:px-6">
            ...
            <p className="mt-4 text-sm md:text-base text-gray-600 leading-relaxed">
              프로필에 걸린 줄을 그대로 가져왔습니다. 업종마다 방문자가 묻는 것이 달라 칸 이름과 장면도 다릅니다. 지금까지 {HL_SHOP_TOTAL}곳에 {HL_TOTAL}장을 만들었습니다.
            </p>
        ...
        <section className="py-14 md:py-20 bg-white">
          <div className="max-w-4xl mx-auto px-4 md:px-6">
            ...
            <p className="mt-4 text-sm md:text-base text-gray-600 leading-relaxed">
              안 되는 글을 살리는 도구가 아니라 되는 글을 더 멀리 보내는 도구입니다. 그래서 반응이 나기 시작한 글에, 올린 직후 몇 시간 안에만 붙입니다.
            </p>
        ...
        <section className="py-14 md:py-20" style={{ background: "var(--h-surface)" }}>
          <div className="max-w-4xl mx-auto px-4 md:px-6">
            ...
            <p className="mt-4 text-sm md:text-base text-gray-600 leading-relaxed">
              팔로워 수는 올리기도 사기도 쉬워서 맨 앞에 두지 않습니다. 대신 아래 넷을 보고, 재지 않은 숫자는 말씀드리지 않습니다.
            </p>
