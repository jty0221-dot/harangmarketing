...
export const metadata: Metadata = {
  ...
  description:
    "네이버 지도에 가게를 등록하는 것까지는 무료이고 사장님이 직접 하실 수 있습니다. 저희가 하는 일은 그다음입니다. 키워드를 골라 넣고 매일 순위를 재서 밀린 자리를 되찾습니다. 순위는 매일 저장한 스냅샷 실측값으로만 말씀드리고 몇 위까지 올려 드린다는 말을 하지 않습니다. 상담 0원.",
  keywords: [
