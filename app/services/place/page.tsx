...
const FAQS: FaqItem[] = [
  ...
  {
    q: "몇 위까지 올려 주시나요?",
    a: "몇 위까지 올려 드린다는 말을 계약서에도 화면에도 쓰지 않습니다. 경쟁 매장이 무엇을 하는지, 네이버가 기준을 언제 바꾸는지는 저희가 정하지 못하기 때문입니다. 대신 매일 순위를 저장해서 밀린 날에 무엇이 바뀌었는지 그날 안에 찾습니다.",
  },
  {
...
const LD = [
  ...
  }),
  {
    ...
    description:
      "네이버 스마트플레이스 정보 최적화, 지역·업종 키워드 세팅, 경쟁 매장 분석, 사진 구성 가이드, 매일 순위 계측과 조정. 순위는 매일 저장한 스냅샷 실측값으로만 보고하고 몇 위까지 올려 드린다는 말을 하지 않습니다.",
    ...
    <>
      ...
      <main className="pt-[104px] md:pt-[108px]">
        ...
        <PlaceRankCasesSection
          ...
          description={`매일 같은 시각에 잰 순위를 그대로 옮겼습니다. 카드 하나가 키워드 하나여서, 한 매장이 키워드 셋을 올렸으면 기록도 셋으로 남습니다. ${PLACE_RANK_AS_OF} 계측분입니다.`}
