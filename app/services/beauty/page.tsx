    ...
    <>
      ...
      <main className="pt-[104px] md:pt-[108px]">
        ...
        <AnswerBlock
          ...
          answer="미용·네일·뷰티 업종은 인스타그램 릴스와 비포애프터 포트폴리오가 가장 효과적입니다. 시술 결과를 눈으로 확인해야 예약으로 이어지는 업종이기 때문입니다. 하랑마케팅이 진행한 경기 파주 네일샵은 6주 만에 예약 가동률이 40%에서 100% 마감으로 바뀌었고, 릴스 1개로 팔로워 300명이던 매장이 2주 만에 예약을 마감한 사례도 있습니다. 뷰티 마케팅 비용은 월 30만원부터 시작합니다."
          facts={[
