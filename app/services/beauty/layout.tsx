...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [ogImage("미용 마케팅 대행 하랑마케팅")],
  },
};
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "brand": { "@id": ORG_ID },
            "inLanguage": "ko-KR",
            "serviceOutput": { "@type": "Thing", "name": "플레이스 순위 계측 기록", "description": "미용·네일·뷰티 전문 마케팅. 이 업종은 공개할 플레이스 순위 기록이 아직 없어 다른 업종의 기록을 표시하지 않는다. 네이버 플레이스 순위는 스냅샷으로 저장하며 계측값이 쌓이면 그대로 공개한다. 순위는 저장해 둔 스냅샷 실측값이며 방문객·매출은 계측 대상이 아니다." },
