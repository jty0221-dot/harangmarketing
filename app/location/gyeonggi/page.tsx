    ...
    <>
      ...
      <main className="pt-[104px] md:pt-[108px]">
        ...
        <AnswerBlock
          ...
          answer="하랑마케팅은 경기도 소상공인을 전문으로 하는 마케팅 대행사입니다. 포천·파주·김포·의정부 등 경기북부는 물론 수원·성남·안양·부천·용인 등 경기 전 지역을 지원합니다. 경기도는 지역 맘카페 영향력이 커서 맘카페 바이럴을 함께 씁니다. 네이버 플레이스 순위는 매일 스냅샷으로 저장해 월 리포트로 공유하며, 지역 카페 키워드에서 56위가 1위가 된 32일 계측 기록이 있습니다. 계약은 월 단위가 기본이라 1개월부터 시작할 수 있고 중도 해지 위약금이 없습니다. 전화 010-7541-9054로 무료 상담이 가능합니다."
          facts={[
