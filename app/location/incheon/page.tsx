...
const INCHEON_LD = {
  ...
  "description": "인천 부평·송도·연수·부천·검단·계양 소상공인 맞춤 마케팅. 네이버 플레이스 SEO, 블로그, 체험단 전문. 10년 경력 대표 직접 관리.",
  "areaServed": [
...
export const metadata: Metadata = {
  title: "인천 소상공인 마케팅 대행사 | 부평·송도·부천·검단 전문",
  description: "인천 부평·송도·연수·부천·검단·계양 소상공인 맞춤 마케팅으로 네이버 플레이스 SEO, 블로그, 체험단을 10년 경력 대표가 직접 관리합니다.",
  keywords: [
  ...
  openGraph: {
    ...
    description: "인천 부평·송도·연수·검단 등 전 지역 담당. 10년 경력 대표 직접 관리.",
    url: `${BASE}/location/incheon`,
    images: [ogImage("인천 마케팅 대행사 하랑마케팅")],
  },
};

const REGIONS = [
  { name: "부평·계산", focus: "구도심 생활 상권 · 플레이스와 블로그 비중이 높다", color: "bg-blue-50 border-blue-100 text-blue-700" },
  { name: "송도·연수", focus: "신도시 · 검색 유입과 인스타 비중이 함께 높다", color: "bg-indigo-50 border-indigo-100 text-indigo-700" },
  { name: "검단·원당", focus: "신규 입주가 이어지는 상권 · 초기 노출 선점이 유리하다", color: "bg-purple-50 border-purple-100 text-purple-700" },
  { name: "구월·남동", focus: "인천 중심 상권 · 학원·병의원 경쟁 밀도가 높다", color: "bg-green-50 border-green-100 text-green-700" },
];
    ...
    <>
      ...
      <main className="pt-[104px] md:pt-[108px]">
        <section className="bg-gray-950 py-16 md:py-24 relative overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto px-4 md:px-6 lg:px-8">
            ...
            <p className="text-gray-400 text-base md:text-lg leading-relaxed mb-8 max-w-2xl">
              부평·송도·검단·구월·연수 등 인천 전 지역의 매장을 맡고 있습니다.
        ...
        <AnswerBlock
          ...
          answer="하랑마케팅은 인천 전 지역 소상공인을 지원합니다. 송도·청라·부평·구월동·검단 등 신도시와 구도심의 검색 패턴이 크게 다르기 때문에 상권별로 키워드를 나눠 공략합니다. 신도시는 맘카페와 인스타그램, 구도심은 네이버 플레이스와 블로그 비중을 높이는 방식입니다. 인천은 서울 대비 경쟁 강도가 낮은 편입니다. 다만 몇 주 안에 몇 위라고 미리 약속드리지는 않고, 상담 때 지금 몇 위인지부터 재 보고 이 상권이 어느 정도 걸리는 자리인지 말씀드립니다. 계약은 월 단위가 기본이라 1개월부터 시작할 수 있고 중도 해지 위약금이 없습니다. 인천은 비대면 상담과 방문 상담 모두 지원하고 상담 비용은 0원입니다."
          facts={[
            { label: "순위 계측", value: "매일 저장" },
