...
const FAQ_CATEGORIES = [
  ...
  },
  {
    ...
    questions: [
      ...
      {
        q: "상위노출 보장형으로 진행할 수 있나요?",
        a: "일반 키워드는 가능합니다. 병원·청소·철거·누수·꽃집·가발처럼 지역과 업종으로 검색 결과가 정리되는 분야가 여기 해당하고, 현재 전국 여러 업종에서 1페이지를 유지 관리하고 있습니다. 반대로 맛집·카페 키워드는 보장형으로 받지 않습니다. 이쪽은 순위를 움직이는 요인이 달라 약속드릴 수 없기 때문입니다. 어느 쪽에 해당하는지는 키워드를 받아본 뒤 진단 단계에서 먼저 알려드립니다.",
      },
      {
        q: "100% 보장은 되나요?",
        a: `키워드에 따라 갈립니다. 일반 키워드는 보장형으로 받고, 맛집·카페 키워드는 받지 않습니다. 어떤 키워드든 무조건 보장한다고 말하는 곳이 있다면 오히려 의심하셔야 합니다. 보장형이 아닌 경우에는 목표 미달 시 전략 즉시 수정, 성과 투명 공개, 전담 팀장 직접 관리라는 원칙으로 진행하며, 이것이 ${SITE.stats.renewalRate} 재계약률로 나타납니다.`,
      },
    ],
  },
  {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: "트래픽이라는 말이 두 가지를 가리켜서 나눠 말씀드립니다. 하나는 프로그램·매크로로 기계가 자동 클릭하는 방식인데 이건 쓰지 않습니다. 사람이 아니라서 들어와 아무것도 하지 않고 나가고, 네이버가 그것을 봅니다. 다른 하나는 실제 사람이 검색해서 들어와 보고 나가는 방식이고, 필요한 경우에는 씁니다. 다만 보조 수단이지 기본이 아닙니다. 기본은 글과 리뷰를 쌓는 것이고, 그것 없이 이것만 하면 결국 다시 떨어집니다.",
      },
      {
        q: "담당자가 자주 바뀌지 않나요?",
        a: "전담 팀장이 모든 프로젝트에 직접 참여합니다. 계약부터 성과 보고까지 담당자가 바뀌지 않는 것이 하랑의 원칙입니다. 500+ 프로젝트 전부 전담 팀장이 직접 관리했습니다.",
      },
      {
        q: "상담 신청 후 얼마나 기다려야 하나요?",
        a: "24시간 이내 전담 팀장이 직접 연락드립니다. 급한 경우 카카오톡으로 문의하시면 평균 10분 내에 응답드립니다.",
      },
    ],
  },
  {
      ...
      <main className="pt-[104px] md:pt-[108px]">
        ...
        <section className="py-14 md:py-20 bg-white border-t border-gray-100">
          <div className="max-w-3xl mx-auto px-4 md:px-6 lg:px-8 text-center">
            ...
            <p className="text-xs text-gray-400 mt-5">상담 비용 없음 · 계약 강요 없음 · 전담 팀장 직접 연락</p>
          </div>
        </section>
      </main>
      <Footer />
