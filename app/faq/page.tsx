...
const FAQ_CATEGORIES = [
  ...
  },
  {
    ...
    questions: [
      ...
      {
        q: "100% 보장은 되나요?",
        a: `키워드에 따라 갈립니다. 일반 키워드는 보장형으로 받고, 맛집·카페 키워드는 받지 않습니다. 어떤 키워드든 무조건 보장한다고 말하는 곳이 있다면 오히려 의심하셔야 합니다. 보장형이 아닌 경우에는 목표 미달 시 전략 즉시 수정, 성과 투명 공개, 대표가 직접 관리라는 원칙으로 진행하며, 이것이 ${SITE.stats.renewalRate} 재계약률로 나타납니다.`,
      },
    ],
  },
  {
