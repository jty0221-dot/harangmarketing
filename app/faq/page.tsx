...
const FAQ_CATEGORIES = [
  {
    ...
    questions: [
      ...
      {
        q: "한 달에 얼마나 드나요?",
        a: "항목별 단가를 더해서 냅니다. 플레이스 SEO 최적화 10~15만원(1회), 대표키워드 관리 3만원(키워드·월), 블로그 관리대행 4만원(편), 블로그·카페 배포 3만원(건), 파워컨텐츠 5만원(편)이 기준입니다. 실제 계약은 한 채널만 하면 월 30만원, 두세 채널을 묶으면 월 45~77만원(평균 61만원), 전 채널 통합은 월 120~220만원(평균 167만원)입니다. 모두 부가세 별도이고 광고 집행비는 실비로 따로 나갑니다.",
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      {
        q: "100% 보장은 되나요?",
        a: `순위·방문객 100% 보장은 어떤 대행사도 솔직히 말하기 어렵습니다. 다만 목표 미달 시 전략 즉시 수정, 성과 투명 공개, 전담 팀장 직접 관리이라는 원칙으로 최선을 다합니다. 이것이 ${SITE.stats.renewalRate} 재계약률로 나타납니다.`,
      },
    ],
  },
  {
    ...
    questions: [
      {
        q: "작은 매장도 효과가 있나요?",
        a: "오히려 소규모 매장일수록 효과가 빠릅니다. 대형 체인보다 지역 키워드 경쟁이 낮기 때문입니다. 플레이스 한 채널만 잡는 월 30만원 구성으로 대표키워드를 1~2위까지 올린 사례가 있습니다.",
      },
      {
        q: "어떤 업종에 가장 효과가 좋나요?",
    ...
    questions: [
      {
        ...
        a: "한 채널만 집중하는 월 30만원 구성으로 시작하실 수 있습니다. 플레이스 SEO 최적화 1회에 대표키워드 5개 관리를 붙이는 조합이 소규모 예산에서 가장 효율이 좋습니다. 세팅이 끝나면 다음 달부터 세팅비가 빠지므로 실제 부담은 더 줄어듭니다.",
      },
      {
