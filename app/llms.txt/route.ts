...
1. **블로그 배포 (최적화·카페)** — 최적화 블로그 배포에 네이버 카페 배포를 함께 진행해 블로그 탭과 카페 탭에 동시 노출. 최블 10건에 카페 5건, 20건에 10건, 30건에 20건 추가 제공. 원고 포함 총 50건 1,715,000원(1건당 34,300원), 원고 미포함 총 50건 1,430,000원(1건당 28,600원), 부가세 별도. 진행 후 게시 URL 전체 전달. 9개 업종 ${REF_TOTAL}개 키워드 실사 레퍼런스 공개. (${B}/services/cafe-distribution)
...
- [블로그 배포 (최적화·카페)](${B}/services/cafe-distribution): 카페 배포 상품 구성·가격·프로세스
