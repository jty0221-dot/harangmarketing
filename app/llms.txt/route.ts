...
### 실제 계약 구간 (부가세 별도 · 광고 집행비 별도)

| 구성 | 실제 범위 | 평균 | 근거 |
| --- | --- | --- | --- |
| 한 채널 집중 (플레이스만 또는 배포만) | 월 30만원 | 30만원 | 계약 2건 |
| 두세 채널 묶음 (플레이스+블로그+광고) | 월 45~77만원 | 61만원 | 계약 2건 |
| 전 채널 통합 (배포+파워컨텐츠+SEO+광고+SNS) | 월 120~220만원 | 167만원 | 계약 5건 |
| 상담·현황 진단·전략 제안 | 0원 (무료) | 0원 | — |
