...
1. **네이버 플레이스 SEO** — 네이버 지도·검색 지역 키워드 상위 노출 최적화. 리뷰·답글률·사진·저장 수·키워드 통합 관리. (${B}/services)
2. **블로그 마케팅 / 블로그 배포(기자단)** — 지역+업종 키워드 상위 노출, 20개 이상 채널 동시 배포.
3. **체험단 모집 대행** — 업종별 맞춤 체험단 모집 및 실사용 후기 확보. 2~4주 내 효과.
4. **인스타그램 마케팅** — 릴스 기획, 해시태그 전략, 콘텐츠 제작, DM 응대.
5. **카카오맵 마케팅** — 카카오맵 플레이스 등록·최적화. 최적화 후 평균 신규 유입 30% 이상 증가.
6. **맘카페 바이럴** — 지역 맘카페 실사용자 후기형 노출. 일반 블로그 대비 전환율 2~3배.
7. **홈페이지형 블로그 제작** — 네이버 블로그를 홈페이지 형태로 재구성.
...
- [서비스 전체](${B}/services): 10개 서비스 상세와 패키지 구성
