...
- 순위를 보장하지 않는다. 몇 위까지 올려 준다는 말을 계약서에도 화면에도 쓰지 않는다. 순위를 정하는 것은 네이버이고 경쟁 매장도 함께 움직이기 때문이다.
...
- [인스타그램 계정 관리](${B}/services/instagram): 계정 진단 30개 항목 · 하이라이트 6칸 세팅 · 피드와 스토리와 릴스 정기 발행 · 반응이 난 게시물의 초기 확산 · 팔로워 구매와 순위 보장은 하지 않음
