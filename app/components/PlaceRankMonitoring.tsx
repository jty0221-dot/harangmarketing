 ...
 *
 * 지키는 것
 *   `실시간` 이라고 쓰지 않는다 — 정해진 시각에 재서 저장한다 (C-42 · 틀린 값이 빈 값보다 나쁘다).
 *   `매일` 도 쓰지 않는다 — 09/21 · 09/22 스냅샷이 비어 있다 (2026-09-25 (금) 결재).
...
const STEPS = [
  {
    title: "재는 시각을 정해 두고 저장합니다",
    body: "관리 중인 키워드 순위를 정해진 시각에 재서 그날 파일로 남깁니다. 지나간 하루는 다시 잴 수 없어서, 재지 못한 날은 빈칸으로 두고 이유부터 확인합니다.",
  },
  {
    title: "떨어진 키워드부터 봅니다",
    body: "직전 계측과 맞대 본 뒤 내려간 키워드만 따로 뽑습니다. 순위가 흔들리는 이유는 매장마다 달라서, 무엇이 바뀌었는지를 먼저 찾습니다.",
  },
  {
    title: "고친 뒤 다시 잽니다",
    ...
    <section className={`py-12 md:py-16 border-t border-gray-100 ${background}`}>
      <div className="max-w-6xl mx-auto px-4 md:px-6 lg:px-8">
        ...
        <p className="mt-2 text-sm text-gray-500 leading-relaxed max-w-2xl">
          플레이스 순위는 올린 날이 끝이 아니라 시작입니다. 정해진 시각에 재서 남기고, 내려간
          키워드는 원인을 찾아 손본 뒤 다시 잽니다.
        </p>
