...
const COMPARISONS = [
  {
    ...
    harang: "대표가 직접 상담하고 계약부터 종료까지 1:1 관리",
    detail: "상담 전화를 받는 사람이 대표입니다. 상담한 사람이 그대로 끝까지 맡습니다.",
  },
  {
    pain: "성과가 없어도 월 비용 그대로 청구됨",
    harang: "월 단위 계약 · 매달 잰 순위를 보고 계속 여부 결정",
    detail: "계약 전 성과 가능 여부를 먼저 솔직하게 말씀드립니다. 어렵다고 판단하면 계약 자체를 권하지 않습니다.",
  },
  {
    pain: "업종 구분 없이 똑같은 패키지 강매",
    harang: "카페·병원·학원·음식점 업종별 맞춤 전략 설계",
  ...
  },
  {
    ...
    harang: "상담한 대표가 진행 방향과 보고를 계속 확인",
    detail: "누가 무엇을 맡더라도 최종 판단과 결과 설명은 상담한 하랑 대표가 책임집니다.",
  },
];
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            <div className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-blue-50 border border-blue-100">
              ...
              <p className="text-xs text-blue-700 font-semibold">
                약속한 작업은 게시 URL 로 전부 확인하실 수 있습니다
              </p>
            </div>
          </div>
        </RevealOnScroll>
