...
const KNOWLEDGE: BotEntry[] = [
  ...
  },
  {
    ...
    answer:
      "플레이스와 블로그는 월 단위예요. 최소 몇 개월을 묶는 조건은 없고, 다음 달 진행하지 않겠다고 말씀만 주시면 그 달까지만 하고 멈춥니다. 인스타 관리·체험단 같은 패키지는 구성상 3개월 단위로 잡히는 경우가 있어요. 다만 솔직하게 말씀드리면 한 달로 효과를 판단하시기는 짧습니다. 보통 2~3개월째부터 움직이는 게 보이거든요. 그래서 처음부터 크게 시작하시라고 권하지 않아요:)",
    actions: ["kakao"],
  },
  {
    keywords: ["트래픽", "자동 클릭", "자동클릭", "프로그램 쓰", "프로그램 사용", "어뷰징", "매크로", "작업", "저품질"],
    answer:
      "아니요, 저희는 트래픽 프로그램이나 자동 클릭 쓰지 않습니다. 그런 방식을 권하는 곳이 있다면 피하시는 게 맞아요. 잠깐 올라갔다가 플레이스가 한 번 걸리면 복구가 안 되고, 그동안 쌓으신 리뷰까지 같이 묻힙니다. 저희는 글과 리뷰를 쌓아서 올리는 방식이라 조금 느립니다. 대신 한 번 올라가면 잘 떨어지지 않고, 발행한 글 링크를 전부 드리기 때문에 무엇을 했는지 직접 확인하실 수 있어요:)",
    actions: ["kakao"],
  },
  {
    keywords: ["어떤 업무", "무슨 일", "어디까지", "업무 범위", "서비스 범위", "뭐 해주", "무엇을 해주", "뭘 해주"],
    answer:
      "네이버 플레이스와 블로그가 주력이고, 카페 배포·인스타그램 관리·사진영상 촬영까지 진행합니다. 플레이스는 최적화와 상위노출 관리, 블로그는 대행 포스팅·체험단·홈페이지형 디자인이에요. 어디부터 하실지는 지금 상태를 보고 같이 정하시면 됩니다. 지역+상호명만 남겨주시면 현재 순위부터 확인해 드릴게요:)",
    actions: ["kakao", "freeCheck"],
  },
  {
    keywords: ["뭘 수정", "어떤 부분을 수정", "실제로 뭐", "어떤 작업", "seo 관리", "플레이스 관리", "최적화 항목"],
    answer:
      "실제로 만지는 건 이런 것들이에요. 1) 업체명·대표키워드·상세설명을 검색에 실제로 걸리는 문구로 다시 씁니다 2) 사진 순서와 메뉴판·가격표 정리 3) 리뷰 유도 동선(영수증리뷰 문구·매장 안내물) 4) 소식·쿠폰 주기적으로 올리기 5) 상위노출을 같이 관리하면서 저장수·길찾기 지표가 움직이게 만드는 작업. 원하시는 게 SEO 부분만인지 상위노출까지 포함인지에 따라 금액이 달라져요:)",
    actions: ["kakao", "freeCheck"],
  },
  {
    keywords: ["경쟁업체", "경쟁사", "경쟁 분석", "경쟁업체 분석", "상위 업체", "누가 위에"],
    answer:
      "네, 해드립니다. 그리고 이건 무료예요. 지금 그 키워드 상위에 어떤 업체가 있는지, 그 집들이 리뷰 몇 개에 어떤 키워드로 잡혀 있는지 정리해서 보여드립니다. 보시고 결정하셔도 되고 안 하셔도 됩니다. 지역+상호명과 띄우고 싶은 키워드를 남겨주시면 확인해서 정리해 드릴게요:)",
    actions: ["kakao", "freeCheck"],
  },
  {
