...
const KNOWLEDGE: BotEntry[] = [
  ...
  },
  {
    ...
    answer:
      "순위는 보장해 드리지 않아요. 몇 위까지 올려 드린다는 말을 계약서에도 화면에도 쓰지 않습니다. 순위를 정하는 건 네이버이고 경쟁 매장도 같이 움직이거든요. 대신 매일 순위를 저장해서 밀린 날에 무엇이 바뀌었는지 그날 안에 찾고, 잰 숫자를 그대로 보여드립니다. 원하시는 키워드를 카카오톡으로 남겨주시면 지금 몇 위인지부터 확인해서 알려드릴게요.",
    actions: ["kakao"],
  },
  {
