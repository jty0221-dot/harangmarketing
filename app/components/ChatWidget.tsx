...
const KNOWLEDGE: BotEntry[] = [
  ...
  },
  {
    ...
    answer:
      "키워드에 따라 나뉘어요. 병원·청소·철거·누수·꽃집·가발처럼 일반 키워드는 상위노출 보장형으로 진행할 수 있고, 지금도 전국 여러 업종에서 1페이지를 유지 관리하고 있습니다. 반면 맛집·카페 키워드는 보장형으로 받지 않습니다. 이쪽은 순위를 움직이는 요인이 달라서 약속드릴 수 없거든요. 원하시는 키워드를 카카오톡으로 남겨주시면 어느 쪽인지 확인해서 알려드릴게요.",
    actions: ["kakao"],
  },
  {
