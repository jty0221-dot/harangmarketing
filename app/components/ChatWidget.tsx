...
const KNOWLEDGE: BotEntry[] = [
  ...
  },
  {
    ...
    answer:
      "아니요, 저희는 트래픽 프로그램이나 자동 클릭 쓰지 않습니다. 그리고 그런 방식을 권하는 곳이 있다면 피하시는 게 맞아요. 잠깐 올라갔다가 플레이스가 한 번 걸리면 복구가 안 되고, 그동안 쌓으신 리뷰까지 같이 묻히거든요. 저희는 글이랑 리뷰를 쌓아서 올리는 방식이라 조금 느린 편이에요. 대신 한 번 올라가면 잘 떨어지지 않고, 발행한 글 링크를 전부 드려서 뭘 했는지 직접 다 보실 수 있어요.",
    actions: ["kakao"],
  },
  {
